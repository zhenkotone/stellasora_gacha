...
五星页面顶部的“更新角色资源”会从 Gitee 公开资源清单检查并下载缺失的角色/秘纹头像。资源保存在 `exports/assets/`，下载文件会进行 SHA-256 校验；更新失败不会影响已有抽卡归档。

打包版会在启动后后台检查所属渠道的软件更新，也可以点击“检查更新”手动检查。新版本下载后会校验 SHA-256，确认无误后自动替换当前 exe 并重新启动。

GitHub 与 Gitee 发行版使用独立更新渠道：从 GitHub 下载的程序读取 GitHub 软件/资源清单，从 Gitee 下载的程序读取 Gitee 软件/资源清单，两边不会交叉下载。
...
![游戏内招募记录分类菜单](docs/images/gacha-history-menu.png)
